...
class TestSearchMCPContracts:
    ...
    @pytest.mark.asyncio
    async def test_jira_search_with_pagination_contract(
        ...
        result = await mcp_client.call_tool(
            "jira_search",
            {"jql": "project = TEST ORDER BY created ASC", "limit": 2, "start_at": 3},
        )
    ...
    async def test_jira_search_fields_mcp_contract(self, mcp_client, atlassian_stub):
        ...
        expected_fields = [
            {"id": "summary", "name": "Summary", "custom": False, "searchable": True},
            {
        ...
        result = await mcp_client.call_tool(
            "jira_search_fields", {"keyword": "summary", "limit": 10}
        )
        ...
        summary_field = next(
            (f for f in response_data if f.get("name") == "Summary"), None
        )
    ...
    async def test_confluence_search_mcp_contract(self, mcp_client, atlassian_stub):
        ...
        expected_search = {
            "results": [
                {
                    "content": {"id": "123456", "title": "Test Page", "type": "page"},
        ...
        result = await mcp_client.call_tool(
            ...
            {"query": "siteSearch ~ 'test page'", "limit": 10},
        )
    ...
    async def test_confluence_cql_search_contract(self, mcp_client, atlassian_stub):
        ...
        result = await mcp_client.call_tool(
            "confluence_search_search", {"query": cql_query, "limit": 5}
        )
    ...
    async def test_confluence_text_search_contract(self, mcp_client, atlassian_stub):
        ...
        result = await mcp_client.call_tool(
            "confluence_search_search",
            {"query": "searchable content documentation", "limit": 10},
        )
    ...
    @pytest.mark.asyncio
    async def test_confluence_search_with_spaces_filter_contract(
        self, mcp_client, atlassian_stub
    ):
        ...
        result = await mcp_client.call_tool(
            "confluence_search_search",
            {"query": "project documentation", "spaces_filter": "PROJ,DEV", "limit": 5},
        )
    ...
    async def test_confluence_user_search_contract(self, mcp_client, atlassian_stub):
        ...
        result = await mcp_client.call_tool(
            ...
            {"query": "user.fullname ~ 'John Doe'", "limit": 10},
        )
    ...
    async def test_search_error_handling_contract(self, mcp_client, atlassian_stub):
        ...
        result = await mcp_client.call_tool(
            "jira_search", {"jql": "project = INVALID_PROJECT", "limit": 5}
        )
    ...
    async def test_search_performance_contract(self, mcp_client, atlassian_stub):
        ...
        result = await mcp_client.call_tool(
            "jira_search", {"jql": "project = TEST", "limit": 100}
        )
