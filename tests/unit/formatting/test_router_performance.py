...
from src.mcp_atlassian.formatting.router import DeploymentType, FormatRouter
    ...
    def test_jira_dev_detection(self):
        ...
        for url in test_urls:
            ...
            assert deployment_type == DeploymentType.CLOUD, (
                f"Failed to detect {url} as cloud"
            )
    ...
    def test_all_cloud_patterns_detected(self):
        ...
        for url, expected_type in test_cases:
            ...
            assert result == expected_type, (
                f"URL {url} detected as {result}, expected {expected_type}"
            )
