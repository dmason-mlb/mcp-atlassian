...
class TestConfluenceMCPContracts:
    ...
    @pytest.mark.asyncio
    async def test_confluence_create_page_mcp_contract(self, mcp_client, atlassian_stub, sample_test_data):
    ...
    @pytest.mark.asyncio
    async def test_confluence_create_page_with_parent_contract(self, mcp_client, atlassian_stub):
    ...
    @pytest.mark.asyncio
    async def test_confluence_create_page_wiki_format_contract(self, mcp_client, atlassian_stub):
    ...
    @pytest.mark.asyncio
    async def test_confluence_update_page_mcp_contract(self, mcp_client, atlassian_stub):
    ...
    @pytest.mark.asyncio
    async def test_confluence_add_comment_mcp_contract(self, mcp_client, atlassian_stub, sample_test_data):
...
```"""
    ...
    async def test_confluence_add_label_mcp_contract(self, mcp_client, atlassian_stub):
        ...
        expected_labels = [
            {"id": "label-1", "name": label_name, "prefix": "global"}
        ]
    ...
    @pytest.mark.asyncio
    async def test_confluence_get_page_children_mcp_contract(self, mcp_client, atlassian_stub):
    ...
    @pytest.mark.asyncio
    async def test_confluence_adf_content_processing_contract(self, mcp_client, atlassian_stub, sample_test_data):
        ...
        if isinstance(body_content, dict):
            ...
            assert len(adf_elements) > 0, "Should find ADF elements in processed content"
