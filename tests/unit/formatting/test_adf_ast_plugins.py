...
:::"""
        ...
        assert (
            panel["content"][0]["content"][0]["text"] == "This is an information panel."
        )
...
:::"""
        ...
        assert any(
            m["type"] == "strong"
            for m in panel["content"][1]["content"][1].get("marks", [])
        )
...
:::"""
        ...
        assert any(
            m["type"] == "strong" for m in second_para["content"][1].get("marks", [])
        )
