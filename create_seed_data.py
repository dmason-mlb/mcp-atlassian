    ...
    async with streamablehttp_client(mcp_url) as (r, w, _):
        async with ClientSession(r, w) as session:
            ...
            result = {
                ...
                "jira": {
                    "issueKey": issue_key,
                    "issueUrl": f"{atlassian_url}/browse/{issue_key}" if issue_key else None,
                },
                "confluence": {
                    "pageId": page_id,
                    "pageUrl": f"{atlassian_url}/wiki/spaces/{confluence_space}/pages/{page_id}" if page_id else None,
                },
            }
